		...
		<div class="content">
			...
			<div class="calcBlock">
				<div class="inputs">
					...
					<div class="input">
						<div id="type_2" class="units">
							<div class="price-block block_active">
								<div class="type_2 unit select quant">Параметр №2</div>
							</div>
							<div class="price-block">
								<div class="input noArrow quant">
									<input type="text" name="adres" placeholder="ВЫСОТА(см)">
								</div>
							</div>
							<div class="price-block">
								<div class="input noArrow quant">
									<input type="text" name="adres" placeholder="ОБЪЕМ(м3)">
								</div>
							</div>
							<div class="price-block">
								<div class="input noArrow quant">
									<input type="text" name="adres" placeholder="ТИРАЖ (количество)">
								</div>
							</div>
							<div class="price-block">
								<div class="input noArrow quant">
									<input type="text" name="adres" placeholder="от">
								</div>
							</div>
							<div class="price-block">
								<div class="input noArrow quant">
									<input type="text" name="adres" placeholder="РАЗМЕР(квадратный метр)">
								</div>
							</div>
							<div class="price-block">
								<div class="input noArrow quant">
							...
							<div class="price-block">
								<div class="type_2 unit select quant">Параметр №2</div>
								<div class="type_2 unit active quant" name="test">Landing-page</div>
								<div class="type_2 unit active quant" name="test2">Корпоративный</div>
								<div class="type_2 unit active quant" name="test2">Магазин</div>
							</div>
							<div class="price-block">
								<div class="input noArrow quant">
									<input type="text" name="adres" placeholder="РАЗМЕР(квадратный метр)">
					...
					<div class="button submit"><span class="text">Рассчитать</span></div>
				</div>
				<div id="calc-result" class="price-block" method="post">
					<div class="itog">
						Ориентировочная стоимость: <span id="form-price" class="count">0р.</span>
					</div>
